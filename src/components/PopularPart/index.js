        ...
        return <div
            ...
            <div
                ...
                <div
                    ...
                    <div className={styles.content}><TextCutter maxLines={1} maxLength={60}>{content0}</TextCutter></div>
                </div>
            </div>
            ...
            <div className={styles["right-text-part"]}>
                ...
                <div className={styles["one-tip"]}
                    ...
                    <div className={styles["tip-content"]}><TextCutter maxLines={1} maxLength={60}>{content1}</TextCutter></div>
                </div>
                <div className={styles["one-tip"]}
                     onClick={() => this.handleClick(2)}>
                    <div className={styles["tip-top"]}>{top2}</div>
                    <div className={styles["tip-title"]}>{title2}</div>
                    <div className={styles["tip-content"]}><TextCutter maxLines={1} maxLength={60}>{content2}</TextCutter></div>
                </div>
                <div className={styles["one-tip"]}
                     onClick={() => this.handleClick(3)}>
                    <div className={styles["tip-top"]}>{top3}</div>
                    <div className={styles["tip-title"]}>{title3}</div>
                    <div className={styles["tip-content"]}><TextCutter maxLines={1} maxLength={60}>{content3}</TextCutter></div>
                </div>
